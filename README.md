...
# อธิบายการทำงานของโปรแกรมแสดงตัวอักษร
...
เป็นภาษาในการเขียนโปรแกรมชนิดหนี่งแต่ใช้งานได้ยากกว่าภาษาชั้นสูง เช่น ภาษาซี เนื่องจากใช้ต้องแปลงกระบวนการทำงานให้อยู่ในรูปรหัสคำสั่ง เช่น SB ซึ่งส่งผลให้มีการใช้งานทที่ซับซ้อนกว่า แต่มีข้อดีในการทำงานที่ต้องการจะประหยัดเนื้อหาคำสั่งและประหยัดเวลาในการเขียนโปรแกรม
...
เป็นภาษาในการเขียนโปรแกรมคอมพิวเตอร์ที่ต่ำที่สุดโดยคอมพิวเตอร์สามารถนำไปใช้ได้โดยตรงโดยไม่ต้องผ่ายการแปลงคำสั่งเนื่องจากจะใช้คำสั่งแบบเลขฐานสอง (Binary code) เป็นการรเขียนคำสั่งด้วยเลข 0 และ 1 

ตัวอย่าง

0010 0000 คำสั่งที่ใช้ในการโหลดข้อมูลจากหน่วยความจำ
